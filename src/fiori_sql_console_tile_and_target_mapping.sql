...
SELECT
ID,
SUBSTR_REGEXPR('(.+)\:(.+)\:(.+)\:(.+)' IN ID GROUP 2 ) AS ID_TYPE,
SUBSTR_REGEXPR('(.+)\:(.+)\:(.+)\:(.+)' IN ID GROUP 3 ) AS CATALOG_PAGE
,PARENTID
,DOMAINID
,REFERENCECHIPID
,CAST(URL AS VARCHAR(1333)) AS URL
,CAST(REFM_URL AS VARCHAR(1333)) AS REFM_URL
,CAST(REF_URL  AS VARCHAR(1333)) AS REF_URL
,SEM_OBJ
,SEM_ACT
...
,URLT_ID
/*
,CAST(URLT_PARAMETERS AS VARCHAR(1333)) AS URLT_PARAMETERS
,CAST(URLT_REFM_PARAMETERS AS VARCHAR(1333)) AS URLT_REFM_PARAMETERS
,CAST(URLT_REF_PARAMETERS AS VARCHAR(1333)) AS URLT_REF_PARAMETERS
*/
,FORM_FACTOR_DESKTOP
,FORM_FACTOR_TABLET
,FORM_FACTOR_PHONE
/*
,PARAMETERS
,CAST(REFM_PARAMETERS AS VARCHAR(1333)) AS REFM_PARAMETERS
,CAST(REF_PARAMETERS AS VARCHAR(1333)) AS REF_PARAMETERS
*/
,ADD_PARAMS_ALLOWED
,SYSTEM_ALIAS
,INFORMATION
